...
#test lottery cant be entered unless started
...
def test_can_pick_winner_correctly():
    ...
    #Mock a chainlink node that returns 777 as a random number
    ...
    #777 % 3 = 0
    #First player wins the lottery
    assert lottery.recentWinner() == account
    #Lottery balance should be 0 after funds are transferred to the winner
    assert lottery.balance() == 0
    #New winner(account 0) should have funds of previous lottery
